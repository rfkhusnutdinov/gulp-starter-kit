...
В качестве шаблонизатора используется [pug](https://pugjs.org/), которые имеет большие возможности, а частности: наследование шаблонов, переменные, миксины и т.д. Выбор пал на данный шаблонизатор ввиду того, что код становится более компактным, в отличии от нативного HTML. Да и такой код (сугубо мое личное мнение) удобнее читать, чем большие портянки на чистом HTML.
